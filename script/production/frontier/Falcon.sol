...
contract Cluster is ManageCluster {
    ...
    function configureCluster() internal override {
        ...
        cluster.ltvs = [
            //               0          1         2         3         4
            //               USDC       USDT      USDf      sUSDf     PT_sUSDf
            /* 0  USDC    */ [LTV_ZERO, LTV_HIGH, LTV__LOW, LTV_ZERO, LTV_ZERO],
            /* 1  USDT    */ [LTV_HIGH, LTV_ZERO, LTV__LOW, LTV_ZERO, LTV_ZERO],
            /* 2  USDf    */ [LTV__LOW, LTV__LOW, LTV_ZERO, LTV_ZERO, LTV_ZERO],
            /* 3  sUSDf   */ [LTV__LOW, LTV__LOW, LTV_HIGH, LTV_ZERO, LTV_ZERO],
            /* 4  PT_sUSDf*/ [LTV__LOW, LTV__LOW, LTV_HIGH, LTV_HIGH, LTV_ZERO]
        ];
