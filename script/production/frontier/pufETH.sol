...
contract Cluster is ManageCluster {
    ...
    address internal constant xpufETH = 0xD7D2802f6b19843ac4DfE25022771FD83b5A7464;
    ...
    function defineCluster() internal override {
        ...
        cluster.assets = [WETH, pufETH, xpufETH];
    }
    ...
    function configureCluster() internal override {
        ...
        cluster.oracleProviders[xpufETH] = "0xFE0Ff10BF1837843250E18C820Db06C0464DDfDB";
