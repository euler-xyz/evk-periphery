...
contract Cluster is ManageCluster {
    ...
    function configureCluster() internal override {
        ...
        cluster.ltvs = [
            ...
            /* 0  USDC      */
            [LTV_ZERO, LTV_HIGH, LTV_ZERO, LTV_ZERO, LTV_ZERO],
            /* 1  lvlUSD    */
            [LTV_HIGH, LTV_ZERO, LTV_ZERO, LTV_ZERO, LTV_ZERO],
            /* 2  slvlUSD   */
            [LTV__LOW, LTV_HIGH, LTV_ZERO, LTV_ZERO, LTV_ZERO],
            /* 3  PT_lvlUSD */
            [LTV__LOW, LTV_HIGH, LTV_ZERO, LTV_ZERO, LTV_ZERO],
            /* 4  PT_slvlUSD*/
            [LTV__LOW, LTV_HIGH, LTV_HIGH, LTV_ZERO, LTV_ZERO]
        ];
    }
}
