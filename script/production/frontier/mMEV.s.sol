...
contract Cluster is ManageCluster {
    ...
    address internal constant PT_mMEV_new = 0x61da65F0534C6A4F4c9757f2979A923c08d6D2aa;
    ...
    function defineCluster() internal override {
        ...
        cluster.assets = [USDC, USDT, mMEV, PT_mMEV, PT_mMEV_new];
    }
    ...
    function configureCluster() internal override {
        ...
        cluster.oracleProviders[PT_mMEV_new] = "0x83910e00f7662146e01f61d555a0577187e9bc11";
        ...
        cluster.ltvs = [
            ...
            /* 0  USDC    */ [LTV_ZERO, LTV_HIGH, LTV_ZERO, LTV_ZERO, LTV_ZERO],
            /* 1  USDT    */ [LTV_HIGH, LTV_ZERO, LTV_ZERO, LTV_ZERO, LTV_ZERO],
            /* 2  mMEV    */ [LTV__LOW, LTV__LOW, LTV_ZERO, LTV_ZERO, LTV_ZERO],
            /* 3  PT_mMEV */ [LTV__LOW, LTV__LOW, LTV_HIGH, LTV_ZERO, LTV_ZERO],
            /* 4  PT_mMEV */ [LTV__LOW, LTV__LOW, LTV_HIGH, LTV_ZERO, LTV_ZERO]
        ];
