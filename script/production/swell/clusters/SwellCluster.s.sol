...
contract Cluster is ManageCluster {
    function defineCluster() internal override {
        ...
        cluster.clusterAddressesPath = "/script/production/swell/clusters/SwellCluster.json";
    ...
    function configureCluster() internal override {
        ...
        cluster.oracleProviders[wstETH] = "CrossAdapter=RedstoneClassicOracle+RedstoneClassicOracle";
        cluster.oracleProviders[weETH ] = "CrossAdapter=RedstoneClassicOracle+RedstoneClassicOracle";
        cluster.oracleProviders[ezETH ] = "CrossAdapter=RedstoneClassicOracle+RedstoneClassicOracle";
        cluster.oracleProviders[rsETH ] = "CrossAdapter=RedstoneClassicOracle+RedstoneClassicOracle";
        cluster.oracleProviders[swETH ] = "CrossAdapter=RedstoneClassicOracle+RedstoneClassicOracle";
        ...
        cluster.supplyCaps[wstETH] = 6_250;
        cluster.supplyCaps[weETH ] = 6_250;
        ...
        cluster.borrowCaps[WETH  ] = 21_250;
        cluster.borrowCaps[wstETH] = 2_500;
        cluster.borrowCaps[weETH ] = 1_560;
        cluster.borrowCaps[ezETH ] = 625;
        ...
        // define IRM classes here and assign them to the assets
        {
            ...
            uint256[4] memory irmUSD_1_SWELL = [uint256(0), uint256(2951312420), uint256(22450463582), uint256(1288490188)];
