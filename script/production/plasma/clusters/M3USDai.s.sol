...
contract Cluster is ManageCluster {
    ...
    function configureCluster() internal override {
        ...
        cluster.oracleProviders[sUSDai] = "";
        cluster.oracleProviders[USDai] = "";
        ...
        {
            // sUSDai - no IRM parameters (not borrowing against itself)
            ...
            cluster.kinkIRMParams[USDai ] = irmUSD_YIELD_RISKIER;
        ...
        //                0               1       2
        //                sUSDai          USDai   USDT0
        /* 0  sUSDai  */ [uint16(0.00e4), 0.90e4, 0.88e4],
        /* 1  USDai   */ [uint16(0.00e4), 0.00e4, 0.88e4],
