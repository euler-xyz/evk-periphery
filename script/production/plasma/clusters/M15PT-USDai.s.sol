...
contract Cluster is ManageCluster {
    function defineCluster() internal override {
        ...
        cluster.clusterAddressesPath = "/script/production/plasma/clusters/M15PT-USDai.json";
    ...
    function configureCluster() internal override {
        ...
        cluster.oracleProviders[PT_USDai_19MAR2026] = "0x9050E86837cFbAC1A6D79BE84428ccBd7f7a7520";
        ...
        cluster.supplyCaps[PT_USDai_19MAR2026] = type(uint256).max;
        cluster.supplyCaps[USDai] = type(uint256).max;
        cluster.supplyCaps[USDT0] = type(uint256).max;

        // define borrow caps here. 0 means no borrow can occur, type(uint256).max means no cap defined hence max amount
        cluster.borrowCaps[PT_USDai_19MAR2026] = type(uint256).max;
        ...
        cluster.ltvs = [
        //                0         1         2
        //                PT-USDai  USDai     USDT0
        /* 0  PT-USDai*/ [LTV_ZERO, LTV_HIGH, LTV__LOW],
