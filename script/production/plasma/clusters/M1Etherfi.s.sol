...
contract Cluster is ManageCluster {
    function defineCluster() internal override {
        ...
        cluster.clusterAddressesPath = "/script/production/plasma/clusters/M1Etherfi.json";
    ...
    function configureCluster() internal override {
        ...
        cluster.oracleProviders[WETH]  = "0x31BF69f94440bFE53A484196875D5330FDb181f5";
        cluster.oracleProviders[WEETH] = "0xEd6BCB3d0aa98a3635ceA0f2aC8F5DF897941552";
        ...
        //                0               1       2
        //                WETH            WEETH   USDT0
        /* 0  WETH    */ [uint16(0.00e4), 0.00e4, 0.00e4],
        /* 1  WEETH   */ [uint16(0.00e4), 0.00e4, 0.00e4],
        /* 2  USDT0   */ [uint16(0.00e4), 0.00e4, 0.00e4]
        ];
