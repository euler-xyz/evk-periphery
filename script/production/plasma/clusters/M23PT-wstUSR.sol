...
contract Cluster is ManageCluster {
    function defineCluster() internal override {
        ...
        cluster.clusterAddressesPath = "/script/production/plasma/clusters/M23PT-wstUSR.json";
    ...
    function configureCluster() internal override {
        ...
        cluster.oracleProviders[PT_wstUSR_26FEB2026] = "0x86E633374243d44AEfcFC33b27c2bABda5D6e51d";
        ...
        cluster.supplyCaps[PT_wstUSR_26FEB2026] = type(uint256).max;
        cluster.supplyCaps[USR] = type(uint256).max;
        cluster.supplyCaps[USDT0] = type(uint256).max;

        // define borrow caps here. 0 means no borrow can occur, type(uint256).max means no cap defined hence max amount
        cluster.borrowCaps[PT_wstUSR_26FEB2026] = type(uint256).max;
        ...
        //                0         1         2
        //                PT-wstUSR  USR     USDT0
        /* 0  PT-wstUSR*/ [LTV_ZERO, LTV_HIGH, LTV__LOW],
