...
contract Cluster is ManageCluster {
    function defineCluster() internal override {
        ...
        cluster.clusterAddressesPath = "/script/production/plasma/clusters/M4Maple.json";
    ...
    function configureCluster() internal override {
        ...
        cluster.oracleProviders[syrupUSDT] = "0x6886246cC3164C2D08522dC8D14aab355b316fA1";
        ...
        cluster.borrowCaps[syrupUSDT] = type(uint256).max;
        ...
        //                     0         1
        //                     syrupUSDT USDT0
        /* 0  Escrow USDT  */ [LTV_ZERO, LTV_SELF]
        ];
    }
