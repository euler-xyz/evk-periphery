...
contract Cluster is ManageCluster {
    function defineCluster() internal override {
        ...
        cluster.clusterAddressesPath = "/script/production/monad/clusters/3p/USDC/gMON-WMON-USDC.json";
    ...
    function configureCluster() internal override {
        ...
        /* 2  USDC     */ [uint16(0.00e4), 0.78e4, 0.00e4]
        ];
