...
contract Cluster is ManageCluster {
    function defineCluster() internal override {
        ...
        cluster.clusterAddressesPath = "/script/production/monad/clusters/3p/AUSD/shMON-WMON-AUSD.json";
    ...
    function configureCluster() internal override {
        ...
        {
            // Base=0.00% APY,  Kink(90.00%)=25.00% APY  Max=150.00% APY
            uint256[4] memory irmWMON = [uint256(0), uint256(1829308363),  uint256(51141157078), uint256(3865470566)];
        ...
        /* 2  AUSD     */ [uint16(0.00e4), 0.80e4, 0.00e4]
        ];
