...
contract Cluster is ManageCluster {
    function defineCluster() internal override {
        ...
        cluster.clusterAddressesPath = "/script/production/monad/clusters/2p/USDT/LBTC-USDT.json";
    ...
    function configureCluster() internal override {
        ...
        cluster.oracleProviders[LBTC] = "0xA72384C9aCE53C7EA783EDc5d47FD755426a883e";
        cluster.oracleProviders[USDT] = "0x2D842527F1E6CD19a643C127B175bb80924B3036";

        // define supply caps here. 0 means no supply can occur, type(uint256).max means no cap defined hence max amount
        cluster.supplyCaps[LBTC] = 150;
        cluster.supplyCaps[USDT] = 12_000_000;

        // define borrow caps here. 0 means no borrow can occur, type(uint256).max means no cap defined hence max amount
        cluster.borrowCaps[LBTC] = 120;
        cluster.borrowCaps[USDT] = 10_800_000;

        // define IRM classes here and assign them to the assets
        {
            // Base=1.00% APY,  Kink(80.00%)=3.00% APY  Max=25.00% APY
            uint256[4] memory irmLBTC = [uint256(315313405426480960), uint256(180841814),  uint256(7141447258), uint256(3435973836)];
        ...
        //                0               1    
        //                LBTC            USDT
        /* 0  LBTC    */ [uint16(0.00e4), 0.87e4],
        /* 1  USDT    */ [uint16(0.87e4), 0.00e4]
        ];
        ...
        //                     0               1    
        //                     LBTC            USDT
        /* 0  Escrow LBTC  */ [uint16(0.97e4), 0.87e4],
        /* 1  Escrow USDT  */ [uint16(0.87e4), 0.97e4]
        ];
    }
