...
contract Cluster is ManageCluster {
    function defineCluster() internal override {
        ...
        cluster.clusterAddressesPath = "/script/production/monad/clusters/2p/USDT/FBTC-USDT.json";
    ...
    function configureCluster() internal override {
        ...
        //                0               1    
        //                FBTC            USDT
        /* 0  FBTC    */ [uint16(0.00e4), 0.83e4],
        /* 1  USDT    */ [uint16(0.83e4), 0.00e4]
        ];
        ...
        //                     0               1    
        //                     FBTC            USDT
        /* 0  Escrow FBTC  */ [uint16(0.97e4), 0.83e4],
        /* 1  Escrow USDT  */ [uint16(0.83e4), 0.97e4]
        ];
    }
