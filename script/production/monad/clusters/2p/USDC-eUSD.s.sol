...
contract Cluster is ManageCluster {
    function defineCluster() internal override {
        ...
        cluster.clusterAddressesPath = "/script/production/monad/clusters/2p/USDC-eUSD.json";
    ...
    function configureCluster() internal override {
        ...
        cluster.supplyCaps[eUSD] = 20_000_000;

        // define borrow caps here. 0 means no borrow can occur, type(uint256).max means no cap defined hence max amount
        cluster.borrowCaps[USDC] = 18_000_000;
        cluster.borrowCaps[eUSD] = 18_000_000;
        ...
        //                     0               1    
        //                     USDC            eUSD
        /* 0  Escrow USDC  */ [uint16(0.97e4), 0.97e4],
