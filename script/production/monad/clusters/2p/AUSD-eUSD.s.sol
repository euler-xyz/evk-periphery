...
contract Cluster is ManageCluster {
    function defineCluster() internal override {
        ...
        cluster.clusterAddressesPath = "/script/production/monad/clusters/2p/AUSD-eUSD.json";
    ...
    function configureCluster() internal override {
        ...
        cluster.supplyCaps[eUSD] = 12_000_000;

        // define borrow caps here. 0 means no borrow can occur, type(uint256).max means no cap defined hence max amount
        cluster.borrowCaps[AUSD] = 10_800_000;
        cluster.borrowCaps[eUSD] = 10_800_000;

        // define IRM classes here and assign them to the assets
        {
            // Base=0.00% APY,  Kink(90.00%)=5.5% APY  Max=18.00% APY
            uint256[4] memory irm = [uint256(0), uint256(438921808),  uint256(8261539992), uint256(3865470566)];

            cluster.kinkIRMParams[AUSD] = irm;
            cluster.kinkIRMParams[eUSD] = irm;
        }
        ...
        //                0               1    
        //                AUSD            eUSD
        /* 0  AUSD    */ [uint16(0.00e4), 0.97e4],
        /* 1  eUSD    */ [uint16(0.96e4), 0.00e4]
        ];
        ...
        //                     0               1    
        //                     AUSD            eUSD
        /* 0  Escrow AUSD  */ [uint16(0.97e4), 0.97e4],
        /* 1  Escrow eUSD  */ [uint16(0.96e4), 0.97e4]
        ];
    }
