...
contract Cluster is ManageCluster {
    function defineCluster() internal override {
        ...
        cluster.clusterAddressesPath = "/script/production/test/tac/clusters/TACCluster.json";
    ...
    function configureCluster() internal override {
        ...
        cluster.oracleProviders[mUSDC] = "0xD41908850AA094889ebe4B773B357b980d86694C";
        cluster.oracleProviders[mWETH] = "0x295690a3F39D68A6fe90E3B240165ef241e03639";
        cluster.oracleProviders[mTON ] = "0xFAF1fE86391d1968CA2fc73aA48856bfa87aCad6";

        // define supply caps here. 0 means no supply can occur, type(uint256).max means no cap defined hence max amount
        cluster.supplyCaps[mUSDC] = type(uint256).max;
        cluster.supplyCaps[mWETH] = 30_000;
        cluster.supplyCaps[mTON ] = 5_000_000;

        // define borrow caps here. 0 means no borrow can occur, type(uint256).max means no cap defined hence max amount
        cluster.borrowCaps[mUSDC] = type(uint256).max;
        cluster.borrowCaps[mWETH] = 25_000;
        cluster.borrowCaps[mTON ] = 4_500_000;
        ...
        // define IRM classes here and assign them to the assets
        {
            ...
            cluster.kinkIRMParams[mUSDC] = irm;
            cluster.kinkIRMParams[mWETH] = irm;
            cluster.kinkIRMParams[mTON ] = irm;
        }
        ...
        //                0               1       2
        //                mUSDC           mWETH   mTON
        /* 0  mUSDC   */ [uint16(0.00e4), 0.80e4, 0.70e4],
        /* 1  mWETH   */ [uint16(0.90e4), 0.00e4, 0.60e4],
        /* 2  mTON    */ [uint16(0.65e4), 0.55e4, 0.00e4]
        ];
