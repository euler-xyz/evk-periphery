...
contract Cluster is ManageCluster {
    address internal constant GOVERNOR_CURVE = 0x40907540d8a6C65c637785e8f8B742ae6b0b9968;

    function defineCluster() internal override {
        // define the path to the cluster addresses file here
        cluster.clusterAddressesPath = "/script/production/mainnet/clusters/CurveCluster.json";
    ...
    function configureCluster() internal override {
        ...
        cluster.oracleRoutersGovernor = GOVERNOR_CURVE;
        cluster.vaultsGovernor = GOVERNOR_CURVE;
        ...
        cluster.feeReceiver = GOVERNOR_CURVE;
        ...
        cluster.oracleProviders[scrvUSD] = "ExternalVault|ChainlinkOracle";
        ...
        cluster.supplyCaps[scrvUSD] = 10_000_000;
        ...
        cluster.borrowCaps[scrvUSD] = type(uint256).max;

        // define IRM classes here and assign them to the assets
        {
            // Base=0% APY,  Kink(90%)=5.13% APY  Max=122.55% APY
            uint256[4] memory irm_USD_1_CURVE = [uint256(0), uint256(410120350), uint256(55332434950), uint256(3865470566)];

            cluster.kinkIRMParams[USDC   ] = irm_USD_1_CURVE;
            cluster.kinkIRMParams[USDT   ] = irm_USD_1_CURVE;
            cluster.kinkIRMParams[PYUSD  ] = irm_USD_1_CURVE;
            cluster.kinkIRMParams[scrvUSD] = irm_USD_1_CURVE;
        }
        ...
        cluster.ltvs = [
        //               0                1       2       3      
        //               USDC             USDT    PYUSD   scrvUSD
        /* 0  USDC    */ [uint16(0.00e4), 0.92e4, 0.92e4, 0.00e4],
        /* 1  USDT    */ [uint16(0.92e4), 0.00e4, 0.92e4, 0.00e4],
        /* 2  PYUSD   */ [uint16(0.92e4), 0.92e4, 0.00e4, 0.00e4],
        /* 3  scrvUSD */ [uint16(0.92e4), 0.92e4, 0.92e4, 0.00e4]
        ];
    ...
    function postOperations() internal override {
        ...
        for (uint256 i = 0; i < cluster.vaults.length; ++i) {
            ...
            PerspectiveVerifier.verifyPerspective(
                ...
                PerspectiveVerifier.E__LTV_COLLATERAL_CONFIG_LENGTH | PerspectiveVerifier.E__ORACLE_INVALID_ROUTER_CONFIG,
                false
            );
        }
