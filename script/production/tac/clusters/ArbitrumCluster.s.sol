...
contract Cluster is ManageCluster {
    function defineCluster() internal override {
        ...
        cluster.clusterAddressesPath = "/script/production/tac/clusters/ArbitrumCluster.json";
    ...
    function configureCluster() internal override {
        ...
        cluster.oracleProviders[USDC  ] = "0xcf23bd82d8Af77d590d13F17907CB6ab12B21084";
        cluster.oracleProviders[USDT0 ] = "0x9C3779e841ec011C138d3cd12A1b4573fA5cf154";
        cluster.oracleProviders[sUSDS ] = "0x886fA4C3399fA4C7eB25841d315fBB3C633eCd4E";

        // define supply caps here. 0 means no supply can occur, type(uint256).max means no cap defined hence max amount
        cluster.supplyCaps[USDC  ] = 100_000_000;
        cluster.supplyCaps[USDT0 ] = 100_000_000;
        cluster.supplyCaps[sUSDS ] = type(uint256).max;
        ...
        // define IRM classes here and assign them to the assets
        {
            ...
            cluster.kinkIRMParams[USDC  ] = irmETH;
            cluster.kinkIRMParams[USDT0 ] = irmUSD_1;
            cluster.kinkIRMParams[sUSDS ] = irmDEFI;
        }
        ...
        //                0               1       2
        //                USDC            USDT0   sUSDS
        /* 0  USDC    */ [uint16(0.00e4), 0.96e4, 0.00e4],
        /* 1  USDT0   */ [uint16(0.96e4), 0.00e4, 0.00e4],
        /* 2  sUSDS   */ [uint16(0.96e4), 0.94e4, 0.00e4]
        ];
