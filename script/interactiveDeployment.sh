...
eulerSwapCompilerOptions="--optimize --optimizer-runs 2500 --use 0.8.27 --evm-version london --out out-euler-swap"
securitizeFactoryCompilerOptions="--optimize --optimizer-runs 10000 --use 0.8.24 --evm-version london --out out-securitize-factory"
