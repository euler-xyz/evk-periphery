...
contract PerspectiveTest is Script, PerspectiveErrors {
    function run() public {
        (bool success, bytes memory ret) = address(0x5Dc3deE40528ae713D46105787bd6072Edf4e807).call(
            abi.encodeCall(BasePerspective.perspectiveVerify, (0xE0Da3a2096D540F4eb2E98EdD8fAe57D52EdA841, false))
        );
