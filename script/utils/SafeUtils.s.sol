    ...
    function getSafeBaseURL() public view returns (string memory) {
        if (
            block.chainid == 1 || block.chainid == 10 || block.chainid == 100 || block.chainid == 130
                ...
                || block.chainid == 57073 || block.chainid == 59144 || block.chainid == 747474 || block.chainid == 8453
                || block.chainid == 9745 || block.chainid == 999
        ) {
    ...
    function _getMultisendAddress(uint256 chainId, bool isCallOnly) internal pure returns (address) {
        if (
            chainId == 1 || chainId == 10 || chainId == 100 || chainId == 130 || chainId == 137 || chainId == 143
                || chainId == 146 || chainId == 1923 || chainId == 239 || chainId == 2390 || chainId == 2818
                || chainId == 30 || chainId == 42161 || chainId == 43114 || chainId == 480 || chainId == 5000
                || chainId == 56 || chainId == 57073 || chainId == 59144 || chainId == 60808 || chainId == 80094
                || chainId == 8453 || chainId == 9745 || chainId == 999
        ) {
