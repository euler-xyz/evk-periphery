...
contract InterestRates is EVaultTestBase {
    ...
    EulerFixedCyclicalBinaryIRMFactory public fixedCyclicalBinaryIRMFactory;
    ...
    function setUp() public override {
        ...
        fixedCyclicalBinaryIRMFactory = new EulerFixedCyclicalBinaryIRMFactory();
        accountLens = new AccountLens();
        oracleLens = new OracleLens(address(0));
        irmLens = new IRMLens(address(irmFactory), address(irmAdaptiveCurveFactory), address(fixedCyclicalBinaryIRMFactory));
